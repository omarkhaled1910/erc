...
export default function AirdropForm({ isUnsafeMode, onModeChange }: AirdropFormProps) {
    ...
    console.log({ tokenData, account, tokenAddress, chainId, config }) // Now properly placed after the hook
    ...
    async function handleSubmit() {
        ...
        const tSenderAddress = chainsToTSender[chainId][contractType] // chain id zkysunc ,eth ,anvil
    ...
    async function getApprovedAmount(tSenderAddress: string | null): Promise<number> {
        console.log("getApprovedAmount", tSenderAddress, account, chainId)
        if (!tSenderAddress) {
